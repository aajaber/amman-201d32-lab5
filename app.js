...
function sumArray(sumArr) { //eslint-disable-line
    arraySum=sum(sumArr[0],sumArr[1])[0];
    arraySum=sum(arraySum,sumArr[2])[0];
     return [arraySum,'2,3,4 was passed in as an array of numbers, and ' +arraySum+' is their sum.']
}
...
function multiplyArray(multArr) { //eslint-disable-line
    arrayMultiply=multiply(multArr[0],multArr[1])[0];
    arrayMultiply=multiply(arrayMultiply,multArr[2])[0];
    return [arrayMultiply,'The numbers 2,3,4 have a product of '+ arrayMultiply+'.']
